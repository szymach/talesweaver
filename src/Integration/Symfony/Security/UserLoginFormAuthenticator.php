...
final class UserLoginFormAuthenticator extends AbstractFormLoginAuthenticator
{
    ...
    {
        return $this->redirectTo($request->getLocale(), 'login');
    }
    ...
    public function onAuthenticationFailure(Request $request, AuthenticationException $exception)
    {
        ...
        return $this->redirectTo($request->getLocale());
    }
    ...
    {
        return "/{$request->getLocale()}/login" === $request->getPathInfo()
    ...
    private function redirectTo(string $locale, string $path = 'index'): RedirectResponse
    {
        return new RedirectResponse($this->router->generate($path, ['_locale' => $locale]));
    }
}
